...
import { discoverMovies, getMovieGenres } from '../utils/tmdb';
    ...
    <div className="pt-[72px] min-h-screen bg-bg-primary">
      ...
      <div className="bg-bg-secondary border-b border-border-color pt-16 pb-12 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4">Discover Movies</h1>
          <p className="text-lg text-text-secondary max-w-2xl">
            Explore our extensive database of movies. Filter by genre, sort by popularity or rating, and discover your next favorite film.
          </p>
        </div>
      </div>
      ...
      <div className="container-custom py-12 flex flex-col lg:flex-row gap-8 items-start">
           ...
           <div className="mb-6">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="revenue.desc">Highest Box Office</option>
                </select>
        ...
        <div className="flex-1 w-full">
           <MovieGrid items={movies} loading={loading} skeletons={20} mediaType="movie" />
           {renderPagination()}
        </div>
      </div>
    </div>
